...
class Program
{
    static void Main(string[] args)
    {
        ...
        var customer1 = new Customer("Bernie Zhong", customerAddress1);
        var customer2 = new Customer("Jane Smith", customerAddress2);

        var products1 = new List<Product>
        {
            new Product("Product1", "1", 10.99, 2),
            new Product("Product1-2", "1-2", 20.49, 1),
        };
        ...
        {
            new Product("Product2", "2", 15.99, 3),
            new Product("Product2-1", "2-1", 18.75, 2),
        };
